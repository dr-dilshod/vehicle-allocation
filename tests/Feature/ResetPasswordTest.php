...
class ResetPasswordTest extends TestCase
{
    ...
    /**
     * Test if it displays the reset password request form.
     * @return void
     */
    ...
    /**
     * Test if sends the password reset email when the user exists.
     * @return void
     */
    ...
    /**
     * Test if it does not send a password reset email when the user does not exist.
     * @return void
     */
    ...
    /**
     * Test if it displays the form to reset a password.
     * @return void
     */
    ...
    /**
     * Test if it allows a user to reset their password.
     * @return void
     */
