        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/shipper/create') }}" class="btn btn-success btn-sm" title="Add New Shipper">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        <form method="GET" action="{{ url('/shipper') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Shipper No</th><th>Shipper Name1</th><th>Shipper Name2</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($shipper as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->shipper_no }}</td><td>{{ $item->shipper_name1 }}</td><td>{{ $item->shipper_name2 }}</td>
                                        <td>
