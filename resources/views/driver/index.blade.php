                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Driver Pass</th><th>Driver Name</th><th>Driver Mobile Number</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($driver as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->driver_pass }}</td><td>{{ $item->driver_name }}</td><td>{{ $item->driver_mobile_number }}</td>
                                        <td>
