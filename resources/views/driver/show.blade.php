                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Driver Pass </th><td> {{ $driver->driver_pass }} </td></tr><tr><th> Driver Name </th><td> {{ $driver->driver_name }} </td></tr><tr><th> Driver Mobile Number </th><td> {{ $driver->driver_mobile_number }} </td></tr>
                                </tbody>
                            </table>
                        </div>
